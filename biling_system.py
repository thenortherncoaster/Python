...
class Bill_App:
    ...
    # ===================Medical====================================
        ...
        F2.place(x=5, y=180, width=381, height=380)
    ...
    # ==========GroceryItems=========================
        ...
        F3.place(x=386, y=180, width=381, height=380)
    ...
    # ===========ColdDrinks================================
        ...
        F4.place(x=772, y=180, width=381, height=380)
    ...
    # =================BillArea======================
        ...
        F5.place(x=1158, y=180, width=381, height=380)
    ...
    # =======================ButtonFrame=============
        ...
        F6.place(x=0, y=600, relwidth=1, height=140)
